...
type ConfigAuthInitParameters struct {
	...
	LdapSearchPasswordSecretRef *v1.LocalSecretKeySelector `json:"ldapSearchPasswordSecretRef,omitempty" tf:"-"`
	...
	// only) Write-only alternative for oidc_client_secret. Must be used together with oidc_client_secret_wo_version.
	OidcClientSecretWo *string `json:"oidcClientSecretWo,omitempty" tf:"oidc_client_secret_wo,omitempty"`
