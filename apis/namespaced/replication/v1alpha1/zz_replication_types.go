...
type ReplicationInitParameters struct {
	...
	// +crossplane:generate:reference:extractor=github.com/buttahtoast/provider-harbor/config/common.ExtractProjectName()
	...
	// +kubebuilder:validation:Optional
	DestNamespaceRef *v1.NamespacedReference `json:"destNamespaceRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	DestNamespaceSelector *v1.NamespacedSelector `json:"destNamespaceSelector,omitempty" tf:"-"`
